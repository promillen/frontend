  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="text-3xl font-bold">Data Forwarding</h1>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <CardTitle>Forwarding Endpoints</CardTitle>
              </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Forwarding Status</CardTitle>
            <CardDescription>
              Devices configured to forward data to endpoints
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground text-center py-8">
              Configure forwarding per device in the Devices view.
            </p>
          </CardContent>
        </Card>
      </div>
