...
const Dashboard = () => {
  ...
  const [activeView, setActiveView] = useState<'dashboard' | 'map' | 'devices' | 'users'>('dashboard');
          ...
          <div className="flex-1 flex flex-col content-fade-in">
            <header className="h-14 flex items-center justify-between border-b bg-background/95 header-backdrop px-6 shadow-sm relative z-50">
              ...
              <div className="flex items-center space-x-3 relative">
                ...
                {/* Map Controls - show for map and dashboard views */}
                {(activeView === 'map' || activeView === 'dashboard') && (
                  <>
                    <MapTileSelector
